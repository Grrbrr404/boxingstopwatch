namespace TimeKeep.Domain.SoundController
{
    ...
    /// </summary>
    public class RoundBeginBoxingBellSoundDefinition : SoundDefinition
    {
        ...
        /// </summary>
        public RoundBeginBoxingBellSoundDefinition()
        {
            _name = "Runden Begin Glocke";
            _phaseToPlaySound = ManagerPhase.Pause;
            _beginPlayback = TimeSpan.Zero;
            _soundLocation = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Sounds\\roundbegin-bell.wav");
